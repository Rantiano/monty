...
/**
 * add_to_stack - This adds a node to the stack.
...
/**
 * print_stack - This function adds a node to the stack.
 ...
 * @line_number: The interger representing the line number of the opcode.
 */
...
/**
 * print_top - This function prints the top node of the stack.
 * @stack: The pointer to a pointer pointing to the top node of the stack.
 * @line_number: The interger representing the line number of the opcode.
 */
